  ...
  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
    ...
    <section className="py-32 px-6 md:px-12 bg-white">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        {[
          { name: 'Rishabh Raj', role: 'Director,Marketing & Fund Raising', initials: 'RR', color: 'bg-bg-soft text-dark-base' },
          { name: 'Charanjeet Singh', role: 'Director, Operations', initials: 'CS', color: 'bg-bg-soft text-dark-base' },
          { name: 'Tushar Sharma ', role: 'Director, Publich Relation & Tech', initials: 'TS', color: 'bg-bg-soft text-dark-base' },
